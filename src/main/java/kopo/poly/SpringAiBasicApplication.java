...
public class SpringAiBasicApplication implements CommandLineRunner {
    ...
    private final INlpService nlpService; // 자연어 처리 (어휘 형태 및 의미와 문장의 구조 및 의미를 분석하여 언어를 이해하는 기술)
    ...
    public void run(String... args) throws Exception {
        ...
        log.info("중복 제거 수행 전 단어 수 : " + distinct.size());
        ...
        for (String s : distinct) {
            ...
            // 빈도수 결과를 정렬하기
            // 정렬을 위해 앱에 저장된 레코드 1개(키, 값)을 리스트 구조로 변경하기
